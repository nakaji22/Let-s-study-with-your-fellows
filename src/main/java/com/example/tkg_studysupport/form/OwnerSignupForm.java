...
public class OwnerSignupForm {
    ...
    /** 講師用登録コード。 */
    @NotNull(message = "講師用登録コードを入力してください。")
    private String ownerRegistrationCode;
    ...
    public String getOwnerRegistrationCode(){
        return this.ownerRegistrationCode;
    }
    ...
    public void setOwnerRegistrationCode(String ownerRegistrationCode){
        this.ownerRegistrationCode = ownerRegistrationCode;
    }
